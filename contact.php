...
$token = "IGQVJWeW8wRFBOallxekNWRVMzS0FiLXNnU3JzQUVfR213VGNBWkZAXOUNjeHFVM3FSWFpOTFcyY1EwdklRcW94NWJibG9SUi1VNWxJSG9ZAand4OUUtRVM2T2VzcjJnTG5mbmZAJbDhLN1RMeW4wZAFNRWQZDZD";
$limit = 10;
...
?>
	...
	<!-- <div class="powr-instagram-feed" id="15fba9f0_1608010856"></div><script src="https://www.powr.io/powr.js?platform=html"></script> -->
  ...
  <main>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="31.274288400000003" data-map-y="-110.9655659" data-pin="images/icons/pin.png" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
                        Preguntas? Contactanos por correo: hgrlvk@email.com
					</p>
...
<!--===============================================================================================-->
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBkommyneKF4m7oLMAgLLNhuvOiAag3MhI"></script>
...
<!--================================COMENTARIOS SCRIPT======================================-->
	<script>
		    ...
		    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
		    ...
		    s.src = 'https://cozastore-comments.disqus.com/embed.js';

...
$registro = $mysql -> query("CALL `sp_consultarprendas` ('$_REQUEST[id_prenda]')") or
die($mysql -> error);
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    ...
                    <form action="consultarproductos.html" method="POST" class="cta">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							value = "<?php echo $reg['id_prenda'];?>" name="idprenda" placeholder="Ingresar id del producto">
						</div>
                        
                       <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"
							value = "<?php echo $reg['nom_prenda'];?>"
							name="nom_prenda" placeholder="Nombre de producto" disabled="disabled">
						</div>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="descripcion"
							value = "<?php echo $reg['descripcion'];?>"
							disabled="disabled" placeholder="Descripcion del producto"></textarea>
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="id_marca" 
							value = "<?php echo $reg['id_marca'];?>"
							placeholder="ID de la marca" disabled="disabled">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" 
							value = "<?php echo $reg['id_proveedor'];?>"
							name="id_proveedor" placeholder="ID proveedor" disabled="disabled">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"
							value = "<?php echo $reg['precio'];?>"
							name="precio" placeholder="Precio" disabled="disabled">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"
							value = "<?php echo $reg['cantidad'];?>"
							name="cantidad" placeholder="Cantidad del producto" disabled="disabled">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" 
							value = "<?php echo $reg['imagen'];?>"
							name="imagen" placeholder="Imagen" disabled="disabled">
						</div>

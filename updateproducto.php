		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    ...
                    <form action="actualizarproducto.php" method="POST" class="cta">
                       ...
                       <div class="bor8 m-b-20 how-pos4-parent">
							...
							name="nom_prenda1" placeholder="Nombre de producto">
						</div>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="descripcion1"
							value = "<?php echo $reg['descripcion'];?>"
							 placeholder="Descripcion del producto"></textarea>
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="id_marca1" 
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
							...
							name="id_proveedor1" placeholder="ID proveedor">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"
							value = "<?php echo $reg['precio'];?>"
							name="precio1" placeholder="Precio">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"
							value = "<?php echo $reg['cantidad'];?>"
							name="cantidad1" placeholder="Cantidad del producto">
						</div>
                        
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" 
							value = "<?php echo $reg['imagen'];?>"
							name="imagen1" placeholder="Imagen">
						</div>
